...
class ModelRunner:
    ...
    def execute_model(
        ...
        if BENCHMARK_RUNNER: 
            ...
            print(f'[{time.time() * 1000:.3f}][{len(seq_group_metadata_list)}] prepare: {elapsed_prepare:.3f}, model: {elapsed_model:.3f}, sample: {elapsed_sample:.3f}, total: {elapsed_total:.3f}')
