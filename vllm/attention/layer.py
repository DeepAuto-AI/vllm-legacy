...
class Attention(nn.Module):
    ...
    def __init__(
        ...
        impl_spec = inspect.signature(impl_cls)
        if 'layer_index' in impl_spec.parameters:
            self.impl = impl_cls(
                num_heads, 
                head_size, 
                scale, 
    ...
    def forward(
        ...
        impl_spec = inspect.signature(self.impl.forward)
        if 'rope_method' in impl_spec.parameters:
